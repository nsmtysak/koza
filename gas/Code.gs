...
function inviteStyles() {
  return [
    ...
    '- 縁起の悪い言い方。「切れました」「無くなりました」「終わります」ではなく、',
    '  「残りわずかとなってまいりました」のように言い換えます。',
    ...
    'ご家族の予定、健康のこと、願掛けで煙草を断っている——',
    'こうした細部を知っている相手からの連絡は、それ自体が刺さる一方で、',
    'ご家庭で見られたときに**「これは誰なのか」**という話になります。',
    'よく覚えている一文ほど、この危うさを抱えています。',
    '細部に触れるのは1通につき1つまで。並べて書かないでください。',
    ''
  ].join('\n');
}
